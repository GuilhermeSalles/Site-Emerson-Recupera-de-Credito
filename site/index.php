   ...
   <main class="main">
      ...
      <section class="about section" id="processo">
         ...
         <h3 class="section__subtitle simples__subtitle">
            Conheça nosso <span>processo</span>
         </h3>
         <div class="about__container container grid">
            <div class="about__data">
            ...
            <div class="about__image">
               <img src="assets/img/comofunc.png" alt="image" width="640px" height="940px">
            </div>
         </div>
      </section>
         ...
         <div class="home__container container grid">
            <div class="home__content">
               <div class="home__data">
                  ...
                  <h1 class="home__title">
                     Estamos amparados na
                  </h1>

                  <h3 class="home__education"> Lei 8.078 do código de defesa do consumidor!</h3>

                  <p class="home_description">
                     Art. 42. Na cobrança de débitos, o consumidor
                     inadimplente não será exposto a ridículo, nem
                     será submetido a qualquer tipo de constrangimento
                     ou ameaça. Parágrafo único.
                  </p>
            ...
            <div class="home__image">
               <img src="assets/img/martelo-art-42-3.png" alt="image" width="640px" height="940px">
            </div>
